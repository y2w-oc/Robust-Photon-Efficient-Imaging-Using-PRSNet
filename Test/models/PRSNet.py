...
class PixelWiseResShrinkBlock(nn.Module):
    def __init__(self, in_channels=32):
        ...
        self.final_relu = nn.Sequential(nn.ReLU(inplace=True))
...
class PixelWiseResShrinkNet(nn.Module):
    def __init__(self, in_channels=1):
        ...
        self.final_conv = nn.Sequential(nn.Conv3d(4, 1, kernel_size=1, stride=(1, 1, 1), bias=True))
